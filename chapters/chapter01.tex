...
文字的右上角注明引用, 所以请使用预定义好的命令 \lstinline`\upcite` 进行参考引用. 比如本论
文模板 `LaTeX-Template-For-NPU-Thesis' \upcite{NWPUThesisLaTeXTemplate} 要求务必
声明引用, 同时预配置了插件 `math-symbols' \upcite{MathSymbolsinLaTeXbypolossk}. 对
...
测试额外的引用文献 \upcite{szegedy2015going}
